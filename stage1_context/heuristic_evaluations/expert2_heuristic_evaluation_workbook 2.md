...
| **Issue**       | **Severity** | Recommendation |
| --------------- | ------------ | -------------- |
| Navegação na app é dificil | 2            | Redesenhar a interface para navegação intuitiva               |
...
| **Issue**       | **Severity** | Recommendation |
| --------------- | ------------ | -------------- |
| Dificil adicionar receitas | 3            | Incluir receitas padrão diretamente na aplicação               |
